...
**Workspace shim:** `src/lerobot-isaac-autoresearch/src/lerobot_isaac_autoresearch/train_wrapper.py`
(editable clone from [github.com/kvgork/lerobot-isaac-autoresearch](https://github.com/kvgork/lerobot-isaac-autoresearch)).
**Programs:** `src/lerobot-isaac-autoresearch/programs/*.md` (canonical)
